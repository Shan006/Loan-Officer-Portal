...
function PaginationClassic({ Record }) {
  return (
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="text-sm text-slate-500 text-center sm:text-left">
        ...
        <span className="font-medium text-slate-600">{Record}</span> of{" "}
        <span className="font-medium text-slate-600">{Record}</span> results
      </div>
    </div>
  );
}
